          ...
          <div className={styles.teamSection}>
            ...
            <div className={styles.teamGrid}>
              <div className={styles.teamMember}>
                ...
                />
                <h3 className={styles.memberName}>Marco Rossi</h3>
                <p className={styles.memberRole}>Fondatore & Curatore</p>
              </div>
              <div className={styles.teamMember}>
                <img 
                  ...
                  className={styles.memberImage}
                />
                <h3 className={styles.memberName}>Luca Bianchi</h3>
                <p className={styles.memberRole}>Art Director</p>
              </div>
              <div className={styles.teamMember}>
                <img 
                  src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=300&h=300&fit=crop&crop=face" 
                  alt="Giulia - Customer Care" 
                  className={styles.memberImage}
                />
                <h3 className={styles.memberName}>Giulia Verdi</h3>
                <p className={styles.memberRole}>Customer Experience</p>
              </div>
            </div>
          </div>
        </div>
